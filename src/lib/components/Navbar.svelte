...
<Menubar.Root class={cn("flex items-center justify-between h-[48px] px-4 bg-background")}>
	<img alt="The project logo" src={logoDark} class="h-full py-2 object-contain hidden dark:block" />
	<img alt="The project logo" src={logoLight} class="h-full py-2 object-contain dark:hidden" />
	<Menubar.Menu>
